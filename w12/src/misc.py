...
class SimpleRobot(object):
    ...
    def Plot(self, s, ax, showlabel=False):
        ...
        pos = np.asarray(pos)
        handles = ax.plot(pos[0], pos[1], "h", markersize=12, color=color)
        if showlabel:
    ...
    def PlotPath(self, ax, showlabels=False, showlegends=True):
