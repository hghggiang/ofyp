...
boundary = [point(551911,4181438),point(554050,4181438),point(554050,4184219),point(551911,4184219)] # test
...
source = point(551950,	4181950); dest = point(554000,	4184000); # test
...
# Path smoothing --------------------------------------------------
maxIter = 1000 # Original value = 1000 for a step size of 1.0
